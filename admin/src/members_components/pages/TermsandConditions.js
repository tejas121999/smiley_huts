  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h3>Reliance on information posted and disclaimer</h3>
        <p>
          The materials contained on our site are provided for general
          information purposes only and do not claim to be or constitute legal
          or other professional advice and shall not be relied upon as such. We
          do not accept any responsibility for any loss which may arise from
          accessing or reliance on the information on this site and to the
          fullest extent permitted by English law, we exclude all liability for
          loss or damages direct or indirect arising from use of this site.
        </p>
        <h3>Information about us</h3>
        <p>
          Aasa.tech is a site operated by Gotarneaasa Technologies PVT. LTD.
          (“We”); we are a company registered in India under registration number
          U72900PN2019OPC183761. Our registered office is Sr. No 55/67, Plot No
          52, Satyavishwa, Pune – 411015.
        </p>
        ...
        <h3>Refund Policy</h3>
        <p>We do not provide any refunds under any circumstances.</p>
        ...
        <p>
          ...
          material posted on our site. You must not modify the paper or digital
          ...
          material on our site must always be acknowledged. You must not use any
          part of the materials on our site for commercial purposes without
          obtaining a licence to do so from us or our licensors. If you print
          off, copy or download any part of our site in breach of these terms of
        ...
        <p>
          ...
          by law, we, and third parties connected to us hereby expressly
          exclude: All conditions, warranties and other terms which might
          otherwise be implied by statute, common law or the law of equity. Any
          ...
          without limitation any liability for: loss of income or revenue; loss
          of business; loss of profits or contracts; loss of anticipated
          savings; loss of data; loss of goodwill; wasted management or office
          time; and for any other loss or damage of any kind, however arising
          and whether caused by tort (including negligence), breach of contract
          or otherwise, even if foreseeable, provided that this condition shall
          ...
          any of the categories set out above. This does not affect our
          liability for death or personal injury arising from our negligence,
          nor our liability for fraudulent misrepresentation or
        ...
        <p>
          The courts will have non-exclusive jurisdiction over any claim arising
          from, or related to, a visit to our site. These terms of use and any
          ...
          claims) shall be governed by and construed in accordance with the law
          of India.
        </p>
        <h3>Variations</h3>
        <p>
        ...
        <p>
          ...
          please contact info@aasa.tech Thank you for visiting our site.
        </p>
      </div>
    </>
  );
